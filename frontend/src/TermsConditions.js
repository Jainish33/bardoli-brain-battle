            ...
            <div className="text-white/90 leading-relaxed space-y-8">
              ...
              <div className="space-y-8">
                ...
                >
                  ...
                  <p className="text-white/80">
                    Submissions will be accepted only between <strong className="text-yellow-400">12:00 PM and 4:00 PM on 22nd June 2025</strong>. Entries submitted after the deadline will not be considered.
                  </p>
                </motion.div>
